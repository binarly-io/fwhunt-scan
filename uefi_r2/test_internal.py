...
class TestInternal(unittest.TestCase):
    def test_convert(self):
        ...
        self.assertEqual(get_guid_str(PROTOCOLS_GUIDS["gEfiSmmVariableProtocolGuid"]), "ED32D533-99E6-4209-9CC02D72CDD998A7")
        self.assertEqual(GUID_TO_NAME["C2702B74-800C-4131-87468FB5B89CE4AC"], "EFI_SMM_ACCESS2_PROTOCOL_GUID")
